...
import { Code2, Globe, Palette, Server, Zap, Smartphone, Settings, Pencil, Briefcase, BarChart3 } from "lucide-react"
...
export default function RolesCarousel(): React.ReactElement {
  ...
  return (
    <section ref={sectionRef} className="relative w-full py-10 px-4 md:px-8 bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-400">
            Find the perfect talent for your next project across all specializations
          </p>
        </div>
