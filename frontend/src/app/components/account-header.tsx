...
import { Search, Mail, Bell, User, Menu, X, Settings, LogOut, Moon, Sun, Briefcase } from "lucide-react"
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button className="p-2 hover:bg-white/10 rounded-lg transition-colors relative">
              <Bell size={20} className="text-white/70 hover:text-white" />
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-black/95 border border-white/10 rounded-lg backdrop-blur-md shadow-xl">
                  <div className="px-4 py-3 border-b border-white/10">
                    ...
                    <p className="text-white/50 text-xs mt-1">john.doe@example.com</p>
                  </div>
                  ...
                  <div className="py-2">
                    ...
                    <div className="px-4 py-2 border-t border-white/10 mt-2">
                      <p className="text-white/50 text-xs font-semibold mb-2">Theme</p>
                      <button
                        onClick={toggleTheme}
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-white/10 bg-black/95 p-4">
          <div className="flex flex-col gap-4">
            ...
            <a
              href="/proposals"
              className="p-2 hover:bg-white/10 rounded-lg transition-colors flex items-center gap-3 text-white/70 hover:text-white"
            >
              <Mail size={20} />
              <span>Proposals</span>
            </a>
