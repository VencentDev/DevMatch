...
const MOCK_PROJECTS: Record<
    string,
    { clientName: string; budget: number; deadline: string }
> = {
    "1": {
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-b border-violet-500/20 bg-black/80 flex items-center justify-between">
                ...
                <div className="lg:hidden text-sm text-white/60 sm:flex sm:gap-4">
                    <p className="text-green-500">Budget: {formatBudget(project.budget)}</p>
                    <p className="text-yellow-500">Deadline: {formatDeadline(project.deadline)}</p>
                </div>
            </div>
