...
const MOCK_PROJECTS: Record<string, ProjectData> = {
  "1": {
    ...
    deadline: "2024-12-25",
    status: "In Progress",
    description: "Complete redesign of the admin dashboard with modern UI components and improved UX.",
  ...
  "2": {
    ...
    deadline: "2024-12-15",
    status: "In Progress",
    description: "Integrate third-party payment API and setup webhooks for transaction handling.",
  ...
  "4": {
    ...
    deadline: "2025-01-15",
    status: "Starting",
    description: "Build a cross-platform mobile app using React Native with backend integration.",
...
export default function ProjectDetails({ projectId }: ProjectDetailsProps): React.ReactElement {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="p-6 border-b border-violet-500/20 space-y-4">
        ...
        <div className="bg-violet-500/10 border border-violet-500/20 rounded-lg p-4 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xl font-bold text-white">{formatBudget(project.budget)}</span>
          </div>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-violet-500/20">
            ...
            <div className="text-right">
              <p className="text-white font-semibold text-sm">{formatDeadline(project.deadline)}</p>
              <p className={`text-xs ${daysUntilDeadline > 7 ? "text-green-400/70" : "text-yellow-400/70"}`}>
      ...
      <div className="flex-1 p-6 space-y-6 overflow-y-auto">
        ...
        {/* Skills */}
        <div>
          <h3 className="text-sm font-semibold text-white mb-3">Skills Required</h3>
