      ...
      <main className="pt-20 pb-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8">
            ...
            <p className="text-white/60">Track and manage all your submitted proposals</p>
          </div>
          ...
          <div className="flex gap-8 relative">
            ...
            >
              <div className="pt-16 md:pt-0 p-4 md:p-0">
                <ProposalsFilters selectedStatuses={selectedStatuses} onStatusChange={setSelectedStatuses} />
              </div>
            </div>
